...
public final class StudentAnalytics {
    ...
    public double averageAgeOfEnrolledStudentsParallelStream(
        ...
        double averageAge = Stream.of(studentArray).parallel()
    ...
    public String mostCommonFirstNameOfInactiveStudentsParallelStream(
        ...
        Map<String, List<Student>> repetitions = Stream.of(studentArray).parallel()
                .filter(s -> !s.checkIsCurrent())
        ...
        for (Map.Entry<String, List<Student>> entry : repetitions.entrySet()) {
            if (mostCommon == null || entry.getValue().size() > mostCommonCount) {
                mostCommon = entry.getKey();
                mostCommonCount = entry.getValue().size();
            }
        }
    ...
    public int countNumberOfFailedStudentsOlderThan20ParallelStream(
        ...
        long students = Stream.of(studentArray).parallel()
